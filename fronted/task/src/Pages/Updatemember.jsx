...
function Updatemember() {
  ...
  // temporary blob URL for a newly selected file
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/members/update`,
        formData,
        {
          headers: {
  ...
  // create a preview URL whenever a new file is picked, and revoke the old one
  useEffect(() => {
    if (member.profilePicture instanceof File) {
  ...
  const avatarSrc =
    member.profilePicture instanceof File
      ? previewUrl
      : member.profilePicture || DEFAULT_AVATAR;

  // Your remaining JSX/form stays here
  return (
      ...
      <div className="main">
        <div className="card">
          <div className="card-header">
            ...
            <h1>Update Member</h1>
            <p className="subtitle">Edit this member's profile details and photo.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="form" noValidate>
            ...
            <div className="avatar-section">
              ...
              />
              <span className="avatar-hint">Click the photo to change it</span>
            </div>
